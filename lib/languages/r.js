...
function RParser(settings) {
    DocsParser.call(this, settings);
}

RParser.prototype = Object.create(DocsParser.prototype);

RParser.prototype.setup_settings = function() {
...
RParser.prototype.parse_function = function(line) {
    var regex = xregexp(
...
RParser.prototype.parse_var = function(line) {
    return null;
};

RParser.prototype.get_arg_name = function(arg) {
    var regex = new RegExp(this.settings.varIdentifier + '(\\s*=.*)?', 'g');
    return arg.replace(regex, '\\1');
};

RParser.prototype.get_arg_type = function(arg) {
