var Parsers = {
  ...
  StataParser: require("./languages/stata"),
  RParser: require("./languages/r"),
};
...
module.exports =
  DocBlockrAtom = (function() {
    ...
    //   if(source_lang === "r")
    //         return new Parsers.RParser(settings);
    ...
    //   else if(source_lang === 'stata')
    //       return new Parsers.StataParser(settings);
    //   else if(source_lang === 'r')
    //       return new Parsers.RParser(settings);
